...
public class IAPKey
{
    public const string PACK1 = "screw.bolt.pack.game.puzzle1";
    public const string PACK2 = "screw.bolt.pack.game.puzzle2";
    public const string PACK3 = "screw.bolt.pack.game.puzzle3";
    public const string PACK4 = "screw.bolt.pack.game.puzzle4";
    public const string PACK5 = "screw.bolt.pack.game.puzzle5";
    public const string PACK6 = "screw.bolt.pack.game.puzzle6";
}
